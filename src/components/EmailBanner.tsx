...
export default function EmailBanner() {
  ...
  return (
    <div className="bg-background-light w-full relative">
      {/* Close Button */}
      <button 
      ...
      <div className="flex flex-col lg:flex-row items-start lg:items-center justify-center gap-4 lg:gap-8 p-6 lg:py-4 lg:px-18">
        {/* Promotional Text */}
        <p className="font-rialta text-body-copy text-text-secondary text-center lg:text-left">
        ...
        <form onSubmit={handleSubmit} className="w-full lg:w-auto">
          <div className="bg-white flex flex-row items-center justify-between gap-1 p-2 rounded-full w-full lg:w-96">
            <input
              type="email"
              value={email}
              onChange={(e) => setEmail(e.target.value)}
              placeholder="Email address"
              className="flex-grow font-rialta text-body-copy text-text-secondary bg-transparent outline-none text-center lg:text-left px-4"
            />
            <button
              type="submit"
